			...
			while (!exit) {
				...
				try {
					...
					case 9:
						...
						// here we will get class cast exception because we are trying to cast bank
						// account to list : Collections.sort((List<BankAccount>) accts.values(), new
