...
import custom_comparators.SortRegAmountComparator;
		...
		try (Scanner sc = new Scanner(System.in);) {
			...
			while (true) {
				...
				case 9:
					...
					break;
				case 10:
					Collections.sort(customersList, new SortRegAmountComparator());
					break;
				case 11:
